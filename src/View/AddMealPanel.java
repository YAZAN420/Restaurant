...
public class AddMealPanel {
    ...
    private JPanel createAddDetailsPanel() {
        ...
        backButton.addActionListener(e -> {
            ...
            MainPanel.menuContentPanel1.setSelectedCategory(catogry);
        ...
        add.addActionListener(e -> {
            if (nameTextField.getText().length() != 0 && IngredientsTextField.getText().length() != 0
                ...
                try {
                    ...
                    LoginRegisterView.notificationView.showNotification( e2.getMessage(),true);
                }
                ...
                LoginRegisterView.notificationView.showNotification("All Fields Are Required!", true);
            }
        });
    ...
    private JButton createRoundedButton(String text) {
        JButton button = new JButton(text) {
            ...
            protected void paintComponent(Graphics g) {
                ...
                g2d.setColor(new Color(238, 121, 50)); 
