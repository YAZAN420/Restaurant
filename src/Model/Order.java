...
public abstract class Order implements Serializable{
    ...
    public Order(ArrayList<Meal> orderList, double tip, int orderID, String status, boolean isCancelable, String notes, int time,String nameUser)  {
        ...
        counter++;
        orders.add(this);
        OrderStorage.saveOrdersToFile(orders);
    ...
    public void cancelOrder() {
        if (isCancelable) {
            try {
                ...
                LoginRegisterView.notificationView.showNotification("Can not cancel this order", true);
            }
        }
        else {
            LoginRegisterView.notificationView.showNotification("Can not cancel this order", true);
