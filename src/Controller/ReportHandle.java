...
public class ReportHandle {
    ...
    public static void loadReport() {
        try (BufferedReader br = new BufferedReader(new FileReader("Reports.txt"))) {
            ...
            ReportService.currentReport.setMostOrderedMeal(ReportService.findMaxValue(ReportService.currentReport.mealsCounter));
            ReportService.currentReport.setMostFrequentCustomers(ReportService.findMaxValue(ReportService.customerOrdersNumber));
            saveReport();
